...
#Retrieve user points (first item retrieved from function)
...
# if the user and the computer roll equal points, the users player is player 1...
...
print("end of round")
    ...
    #if the second person's sore is
